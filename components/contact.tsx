...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="py-20 bg-background/50 backdrop-blur-sm">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a href="mailto:obansal.kunalo@gmail.com" className="text-foreground hover:text-primary transition-colors">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a href="tel:+919050207670" className="text-foreground hover:text-primary transition-colors">
                    +91-9050207670
                  </a>
                </div>
              </div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Textarea id="message" name="message" value={formData.message} onChange={handleChange} placeholder="Your message" required className="w-full min-h-[150px]" />
